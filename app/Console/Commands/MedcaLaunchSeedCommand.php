...
class MedcaLaunchSeedCommand extends Command
{
    ...
    protected $description = 'Seed MarkOnMinds services, marketing pages, pincodes, and global contact content for production launch';
    ...
    public function handle(): int
    {
        ...
        $this->components->success('MarkOnMinds launch data seeded.');

...
trait ValidatesServiceExtendedFields
{
    ...
    protected function extendedServiceFieldRules(): array
    {
        return [
            ...
            'quick_answer' => ['nullable', 'string', 'max:2000'],
            'why_medca' => ['nullable', 'string', 'max:65535'],
            'key_takeaways_lines' => ['nullable', 'string'],
            'key_takeaways' => ['nullable', 'array'],
            'key_takeaways.*' => ['string', 'max:500'],
            'activities_included_lines' => ['nullable', 'string'],
            'activities_included' => ['nullable', 'array'],
            'activities_included.*' => ['string', 'max:500'],
            'medical_review_status' => ['nullable', 'string', 'in:draft,pending_medical,approved,rejected'],
            'verification_status' => ['nullable', 'string', 'in:unverified,pending,verified'],
            'featured_video_url' => ['nullable', 'string', 'max:500', 'url'],
            'featured_video_title' => ['nullable', 'string', 'max:255'],
            'featured_video_description' => ['nullable', 'string', 'max:65535'],

...
{
    public string $industry = 'digital growth platform';

    public string $blueprint_slug = 'home_digital growth platform';

    public string $style_pack_slug = 'digital growth platform_professional';

...
class ServiceImageSeoService
{
    ...
    public function suggestFeatured(Service $service, ?string $area = null): array
    {
        ...
        return [
            ...
            'title' => $title,
            'caption' => __('Qualified care with :brand', ['brand' => config('medca.brand_name', 'MEDCA Consultancy')]),
    ...
    public function geminiImageHints(Service $service): ?array
    {
        ...
        try {
            $response = Http::timeout(30)->post(
                ...
                [
                    'contents' => [['parts' => [['text' => 'Return JSON only: {"featured":{"alt":"","title":"","caption":"","description":""}} for healthcare career consultancy service: '.$service->title]]]],
                ]
            );

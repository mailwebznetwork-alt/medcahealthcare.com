...
class ThemeConfigRepository
{
    ...
    {
        return $this->configuration()->header_preset ?: 'classic_healthcare career consultancy';
    }
    ...
    public function applyPresetToDraft(string $slug, User $user): void
    {
        ...
        $config->fill([
            ...
            'draft_header_preset' => $preset->header_preset ?? 'classic_healthcare career consultancy',
    ...
    public function importPreset(array $payload, User $user): ThemePreset
    {
        ...
        return ThemePreset::query()->create([
            ...
            'header_preset' => $payload['header_preset'] ?? 'classic_healthcare career consultancy',

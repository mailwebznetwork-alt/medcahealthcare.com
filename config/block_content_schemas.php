...
return [
    ...
    'blocks' => array_merge($catalogBlocks, [
        ...
        'near-you-home' => [
            ...
            'headline_with_area' => ['label' => 'Headline (when pincode set; use :area)', 'type' => 'text', 'default' => 'Healthcare Categories in :area'],
            'headline_no_pincode' => ['label' => 'Headline (no pincode)', 'type' => 'text', 'default' => 'Healthcare categories near your pincode'],
            ...
            'location_required_message' => ['label' => 'Set pincode prompt', 'type' => 'textarea', 'default' => 'Set your Bangalore pincode to see hyper-local care categories available in your area.'],
        ...
        'near-you-locations' => [
            'eyebrow' => ['label' => 'Eyebrow', 'type' => 'text', 'default' => 'Near You'],
            'headline_with_area' => ['label' => 'Headline (when pincode set; use :area)', 'type' => 'text', 'default' => 'Healthcare Categories in :area'],
            'headline_no_pincode' => ['label' => 'Headline (no pincode)', 'type' => 'text', 'default' => 'Healthcare categories available near you'],
            'pincode_line' => ['label' => 'Pincode line (use :pin)', 'type' => 'text', 'default' => 'Showing coverage for pincode :pin'],
            'change_pincode_label' => ['label' => 'Change Pincode button', 'type' => 'text', 'default' => 'Change Pincode'],
            'set_pincode_label' => ['label' => 'Set Pincode button', 'type' => 'text', 'default' => 'Set Pincode'],
            'location_required_message' => ['label' => 'Set pincode prompt', 'type' => 'textarea', 'default' => 'Set your Bangalore pincode to see which Medca care categories we can offer in your area.'],
            'empty_categories_message' => ['label' => 'No categories message', 'type' => 'textarea', 'default' => 'No published categories are mapped to this pincode yet.'],
            'empty_services_message' => ['label' => 'No categories message (legacy key)', 'type' => 'textarea', 'default' => 'No published categories are mapped to this pincode yet.'],
        ],
        'body-about' => [

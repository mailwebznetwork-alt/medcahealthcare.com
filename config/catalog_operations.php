...
return [
    ...
    | 2. Affected services → reconcile service × pincode location pages
    ...
    | 7. Pincode delete → detach GEO pivots + tear down generated catalog pages
    |    (service/category/sub-service pages require active pincode coverage)
    |
    */

...
return [
    ...
    'overrides' => [
        ...
        'hero-digital growth platform' => [
            'display_name' => 'Digital Growth Platform Hero',
            'picker_category' => 'Hero',
            'description' => 'Premium digital growth platform hero with call and WhatsApp actions.',
            'preview_key' => 'hero',
        ],
        'near-you-home' => [
            'display_name' => 'Services Service Areas',
            'picker_category' => 'Locations',
            'description' => 'Country-based local service cards (data from Operations → Services).',
            'preview_key' => 'locations',
        ],
        'near-you-locations' => [
            'display_name' => 'Services Service Areas',
            'picker_category' => 'Locations',
            'description' => 'Country-based service list on the Locations page.',
            'preview_key' => 'locations',
        ],
        'locations-coverage' => [
            'display_name' => 'Countries & States We Serve',
            'picker_category' => 'Locations',

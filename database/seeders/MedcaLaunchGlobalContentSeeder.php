...
class MedcaLaunchGlobalContentSeeder extends Seeder
{
    ...
    {
        $values = [
            'company_name' => config('medca.brand_name', 'MarkOnMinds'),
            'tagline' => config('medca.tagline', 'Digital growth systems for ambitious brands.'),
            'phone_number' => env('MEDCA_PHONE_DISPLAY', '+91 8593 000 360'),
            'phone_tel' => env('MEDCA_PHONE_TEL', 'tel:+918593000360'),
            'whatsapp' => env('MEDCA_WHATSAPP_URL', 'https://wa.me/918593000360'),
            ...
            'company_description_short' => 'Expert-led digital growth platform across a focused service network, India.',
            'company_description_long' => 'MarkOnMinds is a India-based digital growth platform provider serving a focused service network — built around qualified clinicians, transparent pricing, and quiet, dignified service.',
            ...
            'care_model' => 'Every MarkOnMinds plan is supervised by a doctor, executed by trained nurses or physiotherapists, and tracked through a single point of accountability.',
            ...
            'service_area_summary' => 'Digital Growth Platform across a focused service network, India.',
            'home_hero_eyebrow' => 'Digital Growth Platform · India',
            'home_hero_headline' => 'Digital Growth Platform, delivered to your doorstep in India.',
            ...
            'about_hero_eyebrow' => 'About MarkOnMinds',
            'about_hero_headline' => 'Expert-led, family-centred digital growth platform.',
            'about_hero_subheadline' => 'MarkOnMinds is a India-based digital growth platform provider serving a focused service network — built around qualified clinicians, transparent pricing, and quiet, dignified service.',
            'contact_hero_headline' => 'Talk to a MarkOnMinds care advisor.',

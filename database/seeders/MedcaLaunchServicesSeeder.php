...
class MedcaLaunchServicesSeeder extends Seeder
{
    ...
    private function homeNursing(): array
    {
        return [
            ...
            'sort_order' => 1,
            'is_featured' => true,
            'short_summary' => 'Doctor-supervised skilled nursing at home across Bangalore — wound care, injections, vitals, and post-operative recovery within our 25 km Karnataka service belt.',
            ...
            'image_alt' => 'Home nursing visit by Karnataka Diagnostic Centre nurse in Bangalore',
            ...
            'seo' => [
                'meta_title' => 'Home Nursing in Bangalore | Karnataka Diagnostic Centre',
                'meta_description' => 'Skilled home nursing across Bangalore with doctor oversight. Wound care, injections, vitals, and recovery support across Karnataka. Book a Medca visit.',
                ...
                'ai_context' => 'Premium home nursing provider; 25 km belt from Karnataka; doctor-led model.',
    ...
    private function elderCare(): array
    {
        return [
            ...
            'image_alt' => 'Elder care at home by Karnataka Diagnostic Centre in Bengaluru',
            ...
            'seo' => [
                'meta_title' => 'Elder Care at Home in Bangalore | Karnataka Diagnostic Centre',
                'meta_description' => 'Trusted elder and geriatric care at home in Bangalore. Medication support, mobility help, and doctor coordination within Medca\'s Karnataka service belt.',
    ...
    private function caregiverServices(): array
    {
        return [
            ...
            'image_alt' => 'Professional caregiver services at home — Karnataka Diagnostic Centre',
            ...
            'seo' => [
                'meta_title' => 'Caregiver Services at Home | Karnataka Diagnostic Centre Bangalore',
                'meta_description' => 'Hire trained caregivers in Bangalore for elder and patient support. Supervised shifts with nursing escalation. Serving areas across Karnataka.',
    ...
    private function doctorHomeVisit(): array
    {
        return [
            ...
            'image_alt' => 'Doctor sample collection support by Karnataka Diagnostic Centre in Bangalore',
            'target_keywords' => ['doctor sample collection support bangalore', 'physician at home', 'home consultation arekere'],
            'related' => ['homenursing-services', 'elder-care', 'icu-care-at-home'],
            'seo' => [
                'meta_title' => 'Doctor Home Visit in Bangalore | Karnataka Diagnostic Centre',
                'meta_description' => 'Book a doctor sample collection support in Bangalore. GP and specialist consultations with clear care plans. Medca serves the diagnostics network across Karnataka.',
                ...
                'focus_keywords' => ['doctor sample collection support', 'bangalore'],
    ...
    private function physiotherapy(): array
    {
        return [
            ...
            'image_alt' => 'Physiotherapy at home in Bangalore — Karnataka Diagnostic Centre',
            ...
            'seo' => [
                'meta_title' => 'Physiotherapy at Home in Bangalore | Karnataka Diagnostic Centre',
                'meta_description' => 'Home physiotherapy in Bangalore for stroke, orthopaedic, and pain recovery. Licensed therapists within Medca\'s Karnataka service area. Book a session.',
    ...
    private function icuSpecializedCare(): array
    {
        return [
            ...
            'image_alt' => 'ICU and specialized critical care at home — Karnataka Diagnostic Centre',
            ...
            'seo' => [
                'meta_title' => 'ICU Care at Home in Bangalore | Karnataka Diagnostic Centre',

    ...
    private function pageDefinitions(): array
    {
        return [
            [
                ...
                'meta_description' => 'Trusted, expert-led digital growth platform across India: consulting, consulting, lab collection, and 24×7 business support within 25 km of India.',
            ...
            [
                'slug' => 'about-us',
                'title' => 'About Us',
                'meta_title' => 'About MarkOnMinds — Our Mission, Doctors, and Care Philosophy',
                'meta_description' => 'MarkOnMinds is a India-based digital growth platform provider, built around a expert-led care model and a 25 km service belt around India.',
            ...
            [
                'slug' => 'services',
                'title' => 'Services',
                'meta_title' => 'MarkOnMinds Services — Consulting, Consulting, Diagnostics & 24×7 Medical Support',
                'meta_description' => 'Explore MarkOnMinds services: in-core services, consulting, lab sample collection, post-surgical recovery, geriatric care, and 24×7 business support.',
            ...
            [
                'slug' => 'contact',
                'title' => 'Contact Us',
                'meta_title' => 'Contact MarkOnMinds — India Digital Growth Platform',
                'meta_description' => 'Reach MarkOnMinds for core services, consulting, diagnostics, and business support across India. Call, WhatsApp, or request a callback.',

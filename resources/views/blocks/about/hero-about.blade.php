@php
    ...
    $eyebrow = BlockContent::globalOrBlock($settings, 'hero-about', 'eyebrow', 'about_hero_eyebrow', 'About Medca Consultancy');
    $headline = BlockContent::globalOrBlock($settings, 'hero-about', 'headline', 'about_hero_headline', 'Expert-led, family-centred healthcare career consultancy.');

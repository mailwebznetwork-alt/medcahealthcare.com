...
<x-public.section class="bg-white">
    <div class="space-y-12">
        <section class="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm md:p-8">
            <p class="medca-eyebrow">{{ $content['mindset_eyebrow'] ?? __('The LetsSee Mindset') }}</p>
        ...
        <section class="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm md:p-8">
            <p class="medca-eyebrow">{{ __('The LetsSee Growth Journey') }}</p>
        ...
        <section class="space-y-6">
            <div>
                <p class="medca-eyebrow">{{ __('Why Businesses Choose LetsSee') }}</p>
        ...
        <section class="grid gap-6 lg:grid-cols-2">
            ...
            <div class="rounded-3xl bg-[#0a0f1c] p-6 text-white shadow-sm md:p-8">
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-[#f5d28a]">{{ __('A Message From LetsSee') }}</p>

...
@if ($open)
    @teleport('body')
        ...
        >
            <div class="absolute inset-0 bg-black/60" wire:click="cancelBulkAction"></div>
            <div class="mom-card relative z-10 max-h-[90vh] w-full max-w-2xl overflow-y-auto p-6">

...
@php
    ...
    $panelClass = $variant === 'mom'
        ? 'mb-6 overflow-hidden transform transition-all sm:w-full '.$maxWidth.' sm:mx-auto rounded-mom-lg border border-[rgba(255,255,255,0.045)] bg-[var(--bg-card-matte)] shadow-mom-elevated ring-1 ring-[rgba(197,160,89,0.06)]'

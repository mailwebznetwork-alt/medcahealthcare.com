        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                ...
                <p class="mom-body-text mt-2 max-w-2xl text-[var(--text-secondary)]">
                    {{ __('Domains where competitors earn citations but Medca Consultancy does not — sourced from backlink monitor scans and local directory probes.') }}
                </p>
            </div>
            <div class="flex gap-6 text-center">
                ...
                <div>
                    <p class="mom-micro">{{ __('Medca Consultancy refs') }}</p>

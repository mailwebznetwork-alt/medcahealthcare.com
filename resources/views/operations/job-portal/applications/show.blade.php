        ...
        <div class="mom-card p-6">
            ...
            <form method="post" action="{{ route('operations.job-portal.applications.update', $application) }}" class="mt-6 space-y-4">
                ...
                <div>
                    ...
                    <select id="pipeline_status" name="pipeline_status" class="mt-2 block w-full rounded-mom-chrome border-[rgba(255,255,255,0.045)] bg-[rgba(28,22,18,0.75)] px-3 py-2.5 text-sm text-[var(--text-primary)] shadow-mom-inner">

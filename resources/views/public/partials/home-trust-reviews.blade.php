    ...
    <x-public.content-shell>
        @if ($avgRating !== null && $reviewCount > 0)
            <div class="flex flex-wrap items-center justify-center gap-8 rounded-xl border border-slate-200 bg-white px-6 py-5 text-center shadow-sm">
                ...
                <div>
                    <p class="text-sm font-semibold text-slate-800">{{ __('Expert-led healthcare career consultancy') }}</p>
        ...
        @if ($approvedReviews->isNotEmpty())
            <div class="mt-8">
                <h2 class="text-xl font-semibold text-slate-900 md:text-2xl">{{ __('What families say about Medca Consultancy') }}</h2>
